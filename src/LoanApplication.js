                    ...
                    <div className="make-transfer rounded-lg py-2 lg:p-4 space-y-4 text-center w-full">
                        <form onSubmit={handleSubmit} className="my-auto p-4 lg:p-8 rounded-xl space-y-6 lg:space-y-12 bg-cyan-700 shadow-xl shadow-gray-700">
                            ...
                            <select id="banks" class="w-full text-black border-2 border-teal-600 bg-white rounded-lg block ease-in duration-500 p-4">
                                ...
                                <input className="w-full text-black p-4 border-2 border-teal-600 bg-white rounded-lg ease-in duration-500" name="amount" onChange={handleChange} value={inputs.amount || ""} type="number"
                                            placeholder="Amount ($)"/>
                                <input className="w-full text-black p-4 border-2 border-teal-600 bg-white rounded-lg ease-in duration-500" name="narration" onChange={handleChange} value={inputs.narration || ""} type="text"
